...
for(let i=0;i<8;i++){
	squares[(i*8)].style.marginLeft=(window.innerWidth-(0.96*window.innerHeight))/2+"px";//lol
	squares[(i*8)+7].style.marginRight=(window.innerWidth-(0.96*window.innerHeight))/2+"px";//lol2
}
